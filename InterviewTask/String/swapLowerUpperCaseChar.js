...
console.log('Input:', input); // Input: tHE qUICK bROWN fOX
console.log('Method 1 (map + ternary):', swapCase1(input)); // Method 1 (map + ternary): The Quick Brown Fox
...
console.log('Method 2 (regex replace):', swapCase2(input)); // Method 2 (regex replace): The Quick Brown Fox
...
console.log('Method 3 (charCodeAt):', swapCase3(input)); // Method 3 (charCodeAt): The Quick Brown Fox
...
console.log('Method 4 (reduce):', swapCase4(input)); // Method 4 (reduce): The Quick Brown Fox
...
console.log('Method 5 (spread + map):', swapCase5(input)); // Method 5 (spread + map): The Quick Brown Fox
